...
vncviewer 192.168.$fx.$ip
echo "====================================================="
################## PROGRESSO STATUS ##############################
BAR='ABRINDO ...'   # MÁXIMO 20 CARACTERES
sleep 1
for i in {1..20}; do
    echo -ne "\r${BAR:0:$i}"
    sleep .1
...
echo
echo "====================================================="
echo -e "$t CONECTADO... IP -$a 192.168.$fx.$ip $end. POR FAVOR VERIFIQUE.";
sleep 2
...
t=Terminal      		
echo -e "DIGITE A $aFAIXA$end REFERÊNTE A SUA FILIAL: "
read fx
echo -e "DIGITE O $aFINAL DO IP$end QUE DESEJA REINICIAR: "
read ip
echo "============================================"
...
# CliPDVs
  clear
  logoCliPDVs
echo -e "----[ ${p}ACESSO VNC (CliPDVs)${end} ]-----
---------------------------------------------------

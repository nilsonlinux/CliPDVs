#!/bin/bash
echo "##########################################################
Atualizando a imagem de todos os PDVs...
################################################################";
...
sleep 1
sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.124 "it-update-imagens.sh";
sleep 1
...
sleep 1
sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.103 "it-update-imagens.sh";
sleep 1
...
sleep 1
sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.105 "it-update-imagens.sh";
sleep 1
...
sleep 1
sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.112 "it-update-imagens.sh";
sleep 1
...
sleep 1
sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.115 "it-update-imagens.sh";
sleep 1
sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.116 "it-update-imagens.sh";
sleep 1
sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.119 "it-update-imagens.sh";
sleep 1
sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.55 "it-update-imagens.sh";
sleep 1
sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.117 "it-update-imagens.sh";
sleep 1
...
sleep 1
echo "TODOS OS TERMINAIS REINICIADO COM SUCESSO";
sleep 3
